// Cohesive editorial hair-campaign imagery, generated for SOUSA — The Hair Expert.
// Signed CDN URLs (Artlist), valid far into the future. Hotlinked deliberately —
// see next.config.ts remotePatterns for the two allowed source hosts.
...
export const campaignImages: Record<string, CampaignImage> = {
  heroBg: {
    id: "heroBg",
    ...
    width: 1280,
    height: 720,
    alt: "Dark brunette hair caught in motion against a near-black background",
  },
  brandBg: {
    id: "brandBg",
    ...
    width: 1280,
    height: 720,
    alt: "Extreme close-up macro texture of dark brunette hair strands",
  },
  strandBrunette: {
    id: "strandBrunette",
    ...
    width: 1280,
    height: 1280,
    alt: "Macro photograph of a silky flowing lock of dark brunette hair",
  },
  strandCopper: {
    id: "strandCopper",
    ...
    width: 1280,
    height: 1280,
    alt: "Macro photograph of a silky flowing lock of copper auburn hair",
  },
  strandBlonde: {
    id: "strandBlonde",
    ...
    width: 1280,
    height: 1280,
    alt: "Macro photograph of a silky flowing lock of warm blonde hair",
  },
  scissorsMacro: {
    id: "scissorsMacro",
    ...
    width: 1280,
    height: 960,
    alt: "Macro photograph of professional chrome hairdressing scissors",
  },
  scissorsCutting: {
    id: "scissorsCutting",
    ...
    width: 1280,
    height: 960,
    alt: "A stylist's hand cutting a lock of dark brunette hair with chrome scissors",
  },
  portraitBrunette: {
    id: "portraitBrunette",
    ...
    width: 960,
    height: 1280,
    alt: "Editorial close crop of dark brunette hair cascading over a shoulder",
  },
  portraitCopper: {
    id: "portraitCopper",
    ...
    width: 960,
    height: 1280,
    alt: "Editorial close crop of copper auburn hair cascading over a shoulder",
  },
  textureDetail: {
    id: "textureDetail",
    ...
    width: 1280,
    height: 1280,
    alt: "Extreme macro of overlapping hair strand texture",
  },
  movementBlur: {
    id: "movementBlur",
    ...
    width: 1280,
    height: 720,
    alt: "Long exposure of dark hair whipping through the air in motion",
  },
  portraitBlonde: {
    id: "portraitBlonde",
    ...
    width: 960,
    height: 1280,
    alt: "Editorial close crop of warm blonde hair cascading over a shoulder",
  },
  salonAtmosphere: {
    id: "salonAtmosphere",
    ...
    width: 1280,
    height: 720,
    alt: "Minimalist boutique hair salon interior with round mirror and styling chair",
  },
  toolsFlatlay: {
    id: "toolsFlatlay",
    ...
    width: 1280,
    height: 960,
    alt: "Flatlay of professional scissors and a comb on dark marble",
  },
};
